...
controller('userCtrl', [
  '$scope', 'Project', 'ProjectType', 'Industry', 'Agent', 'User', 'Area', 'Sales', '$routeParams', '$location', function($scope, Project, ProjectType, Industry, Agent, User, Area, Sales, $routeParams, $location) {
    ...
    $scope.editProducts = function(p) {
      var agent, pids, product, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      $scope.isEditProduct = true;
      pids = p.agent.products.map(function(p) {
        return p._id;
      });
      _ref = $scope.agents;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        agent = _ref[_i];
        if (agent._id === p.agent._id) {
          _ref1 = agent.products;
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            product = _ref1[_j];
            if (_ref2 = product._id, __indexOf.call(pids, _ref2) < 0) {
